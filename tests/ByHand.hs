...
sMap2 :: forall (a :: List k1) (f :: k1 ~> k2). Proxy f ->
...
sZipWith :: forall (k1 :: a ~> b ~> c) (k2 :: List a) (k3 :: List b).
...
sFindIndices :: forall (t1 :: a ~> Bool) (t2 :: (List a)).
                Sing t1
             -> Sing t2
...
{-
sFI :: forall (t1 :: a ~> Bool) (t2 :: List a). Sing t1
    -> Sing t2
    -> Sing (FISym0 @@ t1 @@ t2)
